...
const FEATURED_SHOP_IDS = ["yak-and-bull", "the-kitchen-skardu", "baltistan-tea-grill-house","dominos-skardu","thefoodcorridor-skardu","the-balti-table", "skyway-pizza", "pizza-king", "mfc", ];
