...
const FEATURED_SHOP_IDS = ["yak-and-bull", "the-kitchen-skardu", "dominos-skardu","thefoodcorridor-skardu","the-balti-table", "skyway-pizza","baltistan-tea-grill-house", "pizza-king", "mfc", ];
