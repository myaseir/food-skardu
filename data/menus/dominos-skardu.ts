export const menu = {
  ...
  categories: [
    ...
    },
    {
      name: "Burger Deals",
      items: [
        { id: "dp-bg-1", name: "Zinger Burger", price: 550, discountPrice: 468, desc: "Crispy zinger fillet burger", image: "https://fillicafepk.com/wp-content/uploads/2023/12/zinger-burgerpsd-450x450.jpg", variants: [] },
        { id: "dp-bg-2", name: "Zinger Burger with Cheese", price: 650, discountPrice: 553, desc: "Zinger burger topped with cheese", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTbmrX4qL28PPpPFfMt2eP6lLddx8cyISAyD6kjomgoug&s=10", variants: [] },
        { id: "dp-bg-3", name: "Chicken Burger", price: 450, discountPrice: 383, desc: "Classic chicken burger", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSKdCNYo0jMWeA40ghBbkdCwEpgUfLNeS6O8zhKuE48HQ&s=10", variants: [] },
        { id: "dp-bg-4", name: "Chicken Burger with Cheese", price: 550, discountPrice: 468, desc: "Chicken burger topped with cheese", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThbE1uwYArTh6FF07omIuI_6RqLV18QfWpsBkpHeZrCo2r2ZGCg7V0y7pZ&s=10", variants: [] },
        { id: "dp-bg-5", name: "Tower Burger", price: 1000, discountPrice: 850, desc: "Stacked double-decker tower burger", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSYVPNhgEw1i33OM8ZvVMF821S6XF65hNZ3noGzRzVqfw&s=10", variants: [] }
      ]
    },
    {
      name: "Paratha Rolls",
      items: [
        { id: "dp-pr-1", name: "Zinger Paratha Roll", price: 550, discountPrice: 468, desc: "Zinger wrapped in paratha", image: "", variants: [] },
        { id: "dp-pr-2", name: "Zinger Cheese Paratha Roll", price: 650, discountPrice: 553, desc: "Zinger and cheese paratha roll", image: "", variants: [] },
        { id: "dp-pr-3", name: "Chicken Paratha Roll", price: 450, discountPrice: 383, desc: "Chicken wrapped in paratha", image: "", variants: [] },
        { id: "dp-pr-4", name: "Bihari Paratha Roll", price: 600, discountPrice: 510, desc: "Spiced bihari kabab paratha roll", image: "", variants: [] },
        { id: "dp-pr-5", name: "Chicken Cheese Paratha Roll", price: 550, discountPrice: 468, desc: "Chicken and cheese paratha roll", image: "", variants: [] },
        { id: "dp-pr-6", name: "Vegetarian Paratha Roll", price: 450, discountPrice: 383, desc: "Fresh vegetable paratha roll", image: "", variants: [] }
      ]
    },
    {
      name: "Shawarma",
      items: [
        { id: "dp-sh-1", name: "Zinger Shawarma", price: 550, discountPrice: 468, desc: "Crispy zinger shawarma wrap", image: "", variants: [] },
        { id: "dp-sh-2", name: "Zinger Shawarma with Cheese", price: 600, discountPrice: 510, desc: "Zinger shawarma with melted cheese", image: "", variants: [] },
        { id: "dp-sh-3", name: "Chicken Shawarma", price: 400, discountPrice: 340, desc: "Classic chicken shawarma", image: "", variants: [] },
        { id: "dp-sh-4", name: "Chicken Shawarma with Cheese", price: 500, discountPrice: 425, desc: "Chicken shawarma with melted cheese", image: "", variants: [] },
        { id: "dp-sh-5", name: "Vegetarian Shawarma", price: 400, discountPrice: 340, desc: "Fresh vegetable shawarma", image: "", variants: [] }
      ]
    },
    {
      name: "Loaded Fries",
      items: [
        { id: "dp-lf-1", name: "Loaded Fries Regular", price: 900, discountPrice: 765, desc: "Fries loaded with toppings", image: "", variants: [] },
        { id: "dp-lf-2", name: "Loaded Fries Large", price: 1300, discountPrice: 1105, desc: "Large loaded fries", image: "", variants: [] },
        { id: "dp-lf-3", name: "Loaded Fries SP Large", price: 1500, discountPrice: 1275, desc: "Special large loaded fries", image: "", variants: [] }
      ]
    },
    {
      name: "Pasta",
      items: [
        {
          ...
          image: "",
          variants: [
            { name: "P-1", price: 900, discountPrice: 765 },
            { name: "P-2", price: 1200, discountPrice: 1020 }
          ]
        },
        {
          id: "dp-ps-2",
          ...
          image: "",
          variants: [
            { name: "P-1", price: 1000, discountPrice: 850 },
            { name: "P-2", price: 1400, discountPrice: 1190 }
          ]
        },
        {
          id: "dp-ps-3",
    ...
    },
    {
      name: "Super Deals",
      items: [
        { id: "dp-sup-1", name: "Super Deal 1 — 3 Chicken Tikka (Regular) + 1 LTR Drink", price: 2850, discountPrice: 2423, desc: "3 Regular Chicken Tikka pizzas with a free 1-liter cold drink", image: "", variants: [] },
        { id: "dp-sup-2", name: "Super Deal 2 — 3 Chicken Tikka (Medium) + 1 LTR Drink", price: 5500, discountPrice: 4675, desc: "3 Medium Chicken Tikka pizzas with a free 1-liter cold drink", image: "", variants: [] },
        { id: "dp-sup-3", name: "Super Deal 3 — 3 Chicken Tikka (Large) + 1 LTR Drink", price: 7800, discountPrice: 6630, desc: "3 Large Chicken Tikka pizzas with a free 1-liter cold drink", image: "", variants: [] }
      ]
    },
    {
      name: "Fried Chicken",
      items: [
        { id: "dp-fc-1", name: "1 Chicken Piece", price: 350, discountPrice: 298, desc: "Single crispy fried chicken piece", image: "", variants: [] },
        { id: "dp-fc-2", name: "2 Chicken Pieces", price: 680, discountPrice: 578, desc: "Two crispy fried chicken pieces", image: "", variants: [] },
        { id: "dp-fc-3", name: "5 Chicken Pieces", price: 1700, discountPrice: 1445, desc: "Five crispy fried chicken pieces", image: "", variants: [] },
        { id: "dp-fc-4", name: "8 Chicken Pieces", price: 2650, discountPrice: 2253, desc: "Eight crispy fried chicken pieces", image: "", variants: [] },
        { id: "dp-fc-5", name: "Hot Wings (10 pcs)", price: 900, discountPrice: 765, desc: "Ten spicy hot wings", image: "", variants: [] },
        { id: "dp-fc-6", name: "Chicken Nuggets (10 pcs)", price: 900, discountPrice: 765, desc: "Ten crispy chicken nuggets", image: "", variants: [] },
        { id: "dp-fc-7", name: "Hot Shots (10 pcs)", price: 900, discountPrice: 765, desc: "Ten spicy hot shots", image: "", variants: [] }
      ]
    },
    {
      name: "French Fries",
      items: [
        { id: "dp-ff-1", name: "French Fries Regular", price: 350, discountPrice: 298, desc: "Classic regular fries", image: "", variants: [] },
        { id: "dp-ff-2", name: "French Fries Large", price: 500, discountPrice: 425, desc: "Large portion of fries", image: "", variants: [] },
        { id: "dp-ff-3", name: "French Fries Family", price: 750, discountPrice: 638, desc: "Family-size portion of fries", image: "", variants: [] }
      ]
    },
     {
